    ...
    <Menu as="div" className="relative inline-flex">
      ...
      >
        ...
        <Menu.Items as="ul" className="focus:outline-none">
          ...
          <Menu.Item as="li">
            {({ active }) => (
              <Link href="#0" onClick={() => signOut()} className={`font-medium text-sm flex items-center py-1 px-3 ${active ? 'text-indigo-600 dark:text-indigo-400' : 'text-indigo-500'}`} href="#0">
                Sign Out
              </Link>
            )}
          </Menu.Item>
